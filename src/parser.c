...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [1] = {
    ...
    [aux_sym_string_without_punctuators_repeat1] = STATE(6),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [23] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string_without_punctuators, 1),
  [25] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_string_without_punctuators, 1),
  [27] = {.entry = {.count = 1, .reusable = false}}, SHIFT(7),
  [29] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_string_without_punctuators_repeat1, 2),
  [31] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_string_without_punctuators_repeat1, 2),
  [33] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_string_without_punctuators_repeat1, 2), SHIFT_REPEAT(7),
  ...
  [60] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_array, 2),
  [62] = {.entry = {.count = 1, .reusable = true}}, SHIFT(3),
  [64] = {.entry = {.count = 1, .reusable = true}}, SHIFT(13),
  [66] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_array_repeat1, 2), SHIFT_REPEAT(3),
  [69] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_array_repeat1, 2),
  [71] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_string_with_punctuators, 1),
  ...
  [81] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_object_repeat1, 2), SHIFT_REPEAT(9),
  [84] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_object_repeat1, 2),
  [86] = {.entry = {.count = 1, .reusable = true}}, SHIFT(16),
  [88] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_string_with_punctuators_repeat1, 2),
  [90] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_string_with_punctuators_repeat1, 2), SHIFT_REPEAT(27),
  [93] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_pair, 3, .production_id = 1),
