...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [21] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_object_repeat1, 1),
  [23] = {.entry = {.count = 1, .reusable = false}}, SHIFT(34),
  [25] = {.entry = {.count = 1, .reusable = false}}, SHIFT(18),
  [27] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string_without_punctuators, 1),
  [29] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_string_without_punctuators, 1),
  [31] = {.entry = {.count = 1, .reusable = false}}, SHIFT(8),
  [33] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_string_without_punctuators_repeat1, 2),
  [35] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_string_without_punctuators_repeat1, 2),
  [37] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_string_without_punctuators_repeat1, 2), SHIFT_REPEAT(8),
  ...
  [50] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string, 1),
  [52] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_array, 3),
  [54] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_object, 4),
  ...
  [64] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_array, 2),
  [66] = {.entry = {.count = 1, .reusable = true}}, SHIFT(2),
  [68] = {.entry = {.count = 1, .reusable = true}}, SHIFT(13),
  [70] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_array_repeat1, 2), SHIFT_REPEAT(2),
  [73] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_array_repeat1, 2),
  [75] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_string_with_punctuators, 1),
  ...
  [85] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_object_repeat1, 2), SHIFT_REPEAT(5),
  [88] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_object_repeat1, 2),
  [90] = {.entry = {.count = 1, .reusable = true}}, SHIFT(16),
  [92] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_string_with_punctuators_repeat1, 2),
  [94] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_string_with_punctuators_repeat1, 2), SHIFT_REPEAT(27),
